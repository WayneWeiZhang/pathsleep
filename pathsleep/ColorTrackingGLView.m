...
- (UIImage*)cropImage 
{
    ...
    sourceRect = CGRectIntersection(sourceRect, self.bounds);
    GLubyte * buffer = (GLubyte*) malloc(sourceRect.size.width*sourceRect.size.height*4);
    memset(buffer, 0, sourceRect.size.width*sourceRect.size.height*4);
    ...
    CGDataProviderRef provider = CGDataProviderCreateWithData(NULL, 
                                                              buffer, 
                                                              sourceRect.size.width*sourceRect.size.height*4, 
                                                              NULL);
